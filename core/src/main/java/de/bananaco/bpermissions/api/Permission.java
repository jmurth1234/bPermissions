...
/**
 * This class stores a String and a Boolean. The hashCode returns the same for a
 * true and a false String, allowing for only storing one in a HashSet which
 * makes for very useful Permission calculation.
 */
public class Permission extends de.bananaco.bpermissions.api.util.Permission {
    ...
    /**
     * Only use in single-set scenarios, use loadFromString(List<String>) in
     * most cases.
     *
     * @param perm
     * @return Permission
    ...
    /**
     * Returns the children of this permission, if any exist. Or simply an empty
     * Map
     *
